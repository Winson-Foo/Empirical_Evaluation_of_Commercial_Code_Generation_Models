...
public class URLBlobContainerRetriesTests extends AbstractBlobContainerRetriesTestCase {
    ...
    protected Matcher<Object> readTimeoutExceptionMatcher() {
        return either(instanceOf(SocketTimeoutException.class))
                    .or(instanceOf(ConnectionClosedException.class))
    ...
    protected BlobContainer createBlobContainer(
        ...
        try {
            ...
            blobContainer = urlBlobStore.blobContainer(BlobPath.EMPTY);
            return blobContainer;
        } catch (MalformedURLException e) {
            throw new IllegalArgumentException("Unable to create URLBlobStore", e);
        }
    }
