...
/**
 * BridgelessDevSupportManager is a modified version of 
 * DevSupportManagerBase with some additional, more flexible APIs
 * for asynchronously loading the JS bundle.
 */
...
class BridgelessDevSupportManager extends DevSupportManagerBase {
  ...
  /**
   * Returns a unique tag for the current DevSupportManager instance.
   */
  @Override
  ...
  /**
   * Asynchronously loads the split JS bundle from the server.
   */
  @Override
  ...
  /**
   * Creates an instance of ReactInstanceDevHelper 
   * to provide additional dev support functionality.
   */
