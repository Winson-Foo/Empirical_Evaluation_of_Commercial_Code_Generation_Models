...
class ScrapyShell:
    ...
    def __init__(self, crawler: Crawler, update_vars: Optional[Callable] = None, code: Optional[str] = None) -> None:
    ...
    def start(self, url: Optional[str] = None, request: Optional[Union[str, Request]] = None, response: Optional[Response] = None, spider: Optional[Spider] = None, redirect: bool = True) -> None:
    ...
    def _schedule(self, request: Request, spider: Spider) -> defer.Deferred:
        ...
        d = self._request_deferred(request)
    ...
    def fetch(self, request_or_url: Union[str, Request], spider: Optional[Spider] = None, redirect: bool = True, **kwargs) -> None:
    ...
    def populate_vars(self, response: Optional[Response] = None, request: Optional[Request] = None, spider: Optional[Spider] = None) -> None:
        import scrapy
    ...
    def _request_deferred(self, request: Request) -> defer.Deferred:
