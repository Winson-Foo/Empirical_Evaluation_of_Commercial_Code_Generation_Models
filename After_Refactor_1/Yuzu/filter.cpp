...
common/logging/log_classes.inc:
...
const char* GetLogClassName(Class log_class) {
    switch (log_class) {
#define CLS(x) \
    case Class::x: return #x;
#define SUB(x, y) \
    case Class::x##_##y: return #x "." #y;
#include "log_classes.inc"
#undef CLS
#undef SUB
        case Class::Count:
...
bool ParseFilterRule(Filter& instance, std::string_view::const_iterator begin, std::string_view::const_iterator end) {
