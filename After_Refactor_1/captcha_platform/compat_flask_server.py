...
def process_request():
    ...
    if interface_manager.total == 0:
        ...
        return jsonify({"message": "", "success": False, "code": -999})
    ...
    image_size = image_utils.size_of_image(image_sample)
    ...
    image_batch, response = image_utils.get_image_batch(interface.model_conf, bytes_batch)
