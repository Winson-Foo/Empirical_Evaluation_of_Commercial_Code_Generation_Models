...
class ColorExtractor:
    ...
    def k_means(self, data, target_color, bg_color1, bg_color2):
        ...
        alpha_value = tf.constant(self.alpha, dtype=tf.float32)
    ...
    def filter_img(self, img, target_color):
        # background color1
        color_1 = img[0, 0, :]
        ...
        filtered_img = self.k_means(img_holder, target_color, color_1, color_2)
...
if __name__ == "__main__":
    ...
    extractor = ColorExtractor(alpha=0.8)
    
    filtered = extractor.filter_img(img_holder, color)

    extractor.compile_graph(sess)