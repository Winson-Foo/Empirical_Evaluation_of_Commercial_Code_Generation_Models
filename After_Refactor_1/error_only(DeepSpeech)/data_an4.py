...
def download_an4(target_dir: str,
    ...
    try:
        if not os.path.exists(raw_tar_path):
            wget.download('https://github.com/SeanNaren/deepspeech.pytorch/releases/download/V3.0/an4.tar.gz', out=raw_tar_path)
...
if __name__ == '__main__':
    ...
    if args.sample_rate != 16000:
        raise ValueError("AN4 only supports sample rate of 16000 currently.")
    download_an4(
