...
def prepare_sample(recording_name, url, target_folder):
    ...
    try:
        ...
        print("Exception occured while downloading {}. Exception: {}",format(url, e))
        return
    ...
    with tempfile.NamedTemporaryFile(suffix=".tgz", mode='wb') as target_tgz:
        ...
        try:
            ...
            print("Exception occurred while getting recording dir. Exception: ", e)
            return
        ...
        if os.path.exists(recordings_dir) and os.path.exists(tgz_prompt_file):
            try:
                ...
                for wav_file in os.listdir(recordings_dir):
                    ...
                    with io.open(target_txt_file, "w", encoding='utf-8') as file:
                ...
                print("Exception occurred while writing files for ", recording_name)
                print(str(e))
                return
        else:
            return
...
if __name__ == '__main__':
    ...
    try:
        ...
        print("Exception occured while getting all files. Exception: {}",format(e))
        exit(1)
    ...
    try:
        ...
        print("Exception occured while creating manifest file. Exception: ", e)
        exit(1)
