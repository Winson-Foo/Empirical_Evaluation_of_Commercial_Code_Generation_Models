...
class Objective(object):
    def __init__(self, cfg):
        ...
        # Added error handling for exceptions raised during model loading
        try:
            ...
            print(f"Exception raised during model loading: {e}")
            exit(1)
...
def main(cfg: OptimizerConfig) -> None:
    try:
        ...
        print(f"Exception raised during optuna optimization: {e}")
        exit(1)
