...
class SparseL1DescentAttack(L1BaseGradientDescent):
    ...
    def __init__(
        ...
        *,
        ...
        """
        Args:
            quantile: Quantile for determining threshold in normalize function.
    ...
    def normalize(
        ...
        """Normalize gradients and remove unwanted positions.
        
        Args:
            gradients: The gradients to be normalized.
            x: The input tensor.
            bounds: The bounds for pixel values.
    ...
    def project(self, x: ep.Tensor, x0: ep.Tensor, epsilon: float) -> ep.Tensor:
        ...
        Args:
            x: The current tensor.
            x0: The original tensor.
            epsilon: The maximum allowed perturbation.

        Returns:
            The projected perturbation.
        """
        delta = flatten(x - x0)
