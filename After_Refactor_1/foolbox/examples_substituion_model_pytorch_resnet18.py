...
# Define an Attack class
class ModelGradientAttack(LinfPGD):
...
def perform_attack(fmodel, images, labels, epsilons):
    # apply the attack
    attack = ModelGradientAttack(model2=fmodel)
...
def main() -> None:
    ...
    perform_attack(fmodel, images, labels, epsilons)
