...
def evolutionary_strategies_gradient_estimator(
    ...
    *,
    ...
    class GradientEstimator(AttackCls):        
        def value_and_grad(
            self,
    ...
    GradientEstimator.__name__ = f"{AttackCls.__name__}WithESGradientEstimator"
    GradientEstimator.__qualname__ = f"{AttackCls.__qualname__}WithESGradientEstimator"
