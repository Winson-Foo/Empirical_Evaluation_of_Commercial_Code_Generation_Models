...
# Register function decorator
def register(f: Callable[..., Tuple[ep.Tensor, ep.Tensor]]) -> Callable[..., Tuple[ep.Tensor, ep.Tensor]]:
    data[f.__name__] = f
    return f
...
# Fixture for reference and perturbed tensors
...
# Test distance representation and string conversion
@pytest.mark.parametrize("p", [0, 1, 2, ep.inf])
