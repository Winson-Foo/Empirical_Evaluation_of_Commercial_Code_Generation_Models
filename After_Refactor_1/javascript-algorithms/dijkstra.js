...
// 1. Move the Dijkstra algorithm implementation to a separate class or module.
...
class DijkstraAlgorithm {
   ...
   */
  static findShortestPaths(graph, startVertex) {
...
// By moving the algorithm to a separate class, it becomes easier to understand and maintain. Other parts of the codebase can use the `DijkstraAlgorithm` class to find the shortest paths in a graph.

// Note: The refactored code assumes that the `Graph` class and the `GraphVertex` class are already defined.
