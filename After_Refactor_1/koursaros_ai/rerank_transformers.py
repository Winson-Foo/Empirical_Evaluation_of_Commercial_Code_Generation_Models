...
class PtTransformersRerankPlugin(RerankModelPlugin):
    ...
    def __init__(self, model_dir: str = 'nboost/pt-tinybert-msmarco',
        ...
        self.logger.info(f'Loading from checkpoint {model_dir}')
    ...
    def get_logits(self, query: str, choices: List[str]) -> List[float]:
        """
        Returns the logits for the given query and choices.

        :param query: Query string.
        :param choices: List of strings representing the choices.
    ...
    def encode(self, query: str, choices: List[str]):
        """
        Returns the encoded tokens for the given query and choices.

        :param query: Query string.
        :param choices: List of strings representing the choices.
        :return: Tuple of input_ids, attention_mask and token_type_ids.
        """
