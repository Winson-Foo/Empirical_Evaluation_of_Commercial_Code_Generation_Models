...
class QRLinearTest(TransformTest):
    def setUp(self):
        ...
        self._initialize_transform_inputs()

    def _initialize_transform_inputs(self):
    ...
    def test_forward_no_cache(self):
        ...
        outputs_ref, logabsdet_ref = self._compute_forward_no_cache_references(inputs, batch_size)
    ...
    def _compute_inverse_no_cache_references(self, inputs, batch_size):
