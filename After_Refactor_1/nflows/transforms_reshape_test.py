...
class SqueezeTransformTest(TransformTest):
    ...
    def setUp(self):
        """
        Set up the SqueezeTransform instance for each test case.
        """
        self.transform = SqueezeTransform()

    def test_forward(self):
        """
        Test the forward method of the SqueezeTransform class.
        """
        batch_size = 10
    ...
    def test_forward_values(self):
        """
        Test the forward method of the SqueezeTransform class with specific input values.
        """
    ...
    def test_forward_wrong_shape(self):
        """
        Test the forward method of the SqueezeTransform class with wrong input shape.
        """
        batch_size = 10
    ...
    def test_forward_inverse_are_consistent(self):
        """
        Test the consistency between the forward and inverse methods of the SqueezeTransform class.
        """
        batch_size = 10
        for inputs in [torch.randn(batch_size, 32, 4, 4), torch.randn(batch_size, 16, 8, 8)]:
            with self.subTest(inputs=inputs):
                self.assert_forward_inverse_are_consistent(self.transform, inputs)

    def test_inverse_wrong_shape(self):
        """
        Test the inverse method of the SqueezeTransform class with wrong input shape.
        """
        batch_size = 10
