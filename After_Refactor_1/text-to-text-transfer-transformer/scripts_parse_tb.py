...
def evaluate_summary_dirs(summary_dirs):
  """Evaluate the summary directories."""
  scores = None
...
def log_evaluation_results(scores):
...
def main(_):
  summary_dirs = get_summary_dirs()
  scores = evaluate_summary_dirs(summary_dirs)
  log_evaluation_results(scores)
