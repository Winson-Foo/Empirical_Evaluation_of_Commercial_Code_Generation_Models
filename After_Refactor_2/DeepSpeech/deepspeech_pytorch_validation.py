...
class CharErrorRate(ErrorRate):
    ...
    def cer_calc(self, transcript: str, reference: str) -> int:
        """
        ...
        return Lev.distance(transcript, reference)
...
class WordErrorRate(ErrorRate):
    ...
    def wer_calc(self, transcript: str, reference: str) -> int:
        """
...
@torch.no_grad()
def run_evaluation(test_loader: torch.utils.data.DataLoader,
