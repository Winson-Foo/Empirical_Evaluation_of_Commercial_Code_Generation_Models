...
class QuantileRegressionDQNActor(DQNActor):
    """
    Actor class for Quantile Regression DQN Agent.
    """
    ...
    def compute_q(self, prediction):
        """
        Computes the Q values from the quantiles.
        Args:
            prediction: The output from the network.
        Returns:
            The Q values.
        """
...
class QuantileRegressionDQNAgent(DQNAgent):
    ...
    def compute_loss(self, transitions):
        ...
        Computes the loss.
        Args:
            transitions: The transitions from the replay buffer.
        Returns:
            The loss.
        """
