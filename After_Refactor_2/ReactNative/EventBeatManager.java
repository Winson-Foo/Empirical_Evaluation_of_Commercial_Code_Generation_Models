...
public final class EventBeatManager implements BatchEventDispatchedListener {
  ...
  /**
   * Constructor for EventBeatManager
   */
  ...
  /**
   * Deprecated constructor for EventBeatManager
   * 
   * @deprecated Use EventBeatManager() instead
   */
  ...
  /**
   * Called when a batch event is dispatched.
   */
  @Override
