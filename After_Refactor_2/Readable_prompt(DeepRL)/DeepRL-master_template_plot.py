...
def plot_games(games, patterns, labels):
    plotter = Plotter()
    plotter.plot_games(
        games=games,
        patterns=patterns,
...
def plot_mujoco():
    games = ['HalfCheetah-v2', 'Walker2d-v2', 'Hopper-v2', 'Swimmer-v2', 'Reacher-v2', 'Ant-v2', 'Humanoid-v2',
             'HumanoidStandup-v2', ]
    patterns = ['remark_ppo']
    labels = ['PPO']
    plot_games(games, patterns, labels)
...
def plot_atari():
    ...
    patterns = ['remark_a2c', 'remark_categorical', 'remark_dqn', 'remark_n_step_dqn', 'remark_option_critic',
