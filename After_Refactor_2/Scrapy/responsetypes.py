...
class ResponseTypes:
    ...
    def from_mimetype(self, mimetype):
        ...
        if mimetype is None:
            return Response
        return self.classes.get(mimetype, self.classes.get(f"{mimetype.split('/')[0]}/*", Response))
    ...
    def from_content_disposition(self, content_disposition):
        filenames = content_disposition.split("; filename=")
        if len(filenames) > 1:
    ...
    def from_headers(self, headers):
        ...
        if cls is Response and b"Content-Disposition" in headers:
            cls = self.from_content_disposition(headers[b"Content-Disposition"].decode('latin-1'))
        return cls
