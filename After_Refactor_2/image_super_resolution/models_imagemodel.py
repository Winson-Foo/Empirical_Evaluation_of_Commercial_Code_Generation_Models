...
class ImageModel:
    ...
    def predict(self, input_image_array, by_patch_of_size=None, batch_size=10, padding_size=2):
        ...
        Args:
            input_image_array (numpy.ndarray): Input image array.
            by_patch_of_size (int): For large image inference. Splits the image into
                patches of the given size.
            padding_size (int): For large image inference. Padding between the patches.
                Increase the value if there are seamlines.
            batch_size (int): For large image inference. Number of patches processed at a time.
                Keep low and increase by_patch_of_size instead.
        
        Returns:
            sr_img (numpy.ndarray): Image output.
        """
