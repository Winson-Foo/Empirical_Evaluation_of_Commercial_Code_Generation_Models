...
class RationalQuadraticSplineTest(torchtestcase.TorchTestCase):
    def test_forward_inverse_are_consistent(self):
        ...
        widths = torch.randn(*shape, num_bins)
        heights = torch.randn(*shape, num_bins)
        derivatives = torch.randn(*shape, num_bins + 1)
    ...
    def test_identity_init(self):
        ...
        widths = torch.zeros(*shape, num_bins)
        heights = torch.zeros(*shape, num_bins)
        derivatives = torch.zeros(*shape, num_bins + 1)
