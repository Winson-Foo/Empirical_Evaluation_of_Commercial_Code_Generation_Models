...
class CompositeTransformTest(TransformTest):
    def test_forward(self):
        """Test forward() method of CompositeTransform."""
        batch_size = 10
        shape = [2, 3, 4]
    ...
    def test_inverse(self):
        """Test inverse() method of CompositeTransform."""
        batch_size = 10
        shape = [2, 3, 4]
        inputs = torch.randn(batch_size, *shape)
...
class MultiscaleCompositeTransformTest(TransformTest):
    def create_transform(self, shape, split_dim=1):
        """
        Create a MultiscaleCompositeTransform with given shape and split dimension.

        Args:
            shape: The shape of the inputs.
            split_dim: The dimension along which to split the inputs.

        Returns:
            A MultiscaleCompositeTransform object.
        """
    ...
    def test_forward(self):
        """Test forward() method of MultiscaleCompositeTransform."""
        batch_size = 5
    ...
    def test_forward_bad_shape(self):
        """Test exception for invalid shape in create_transform()."""
        shape = (8,)
    ...
    def test_forward_bad_split_dim(self):
        """Test exception for invalid split dimension in create_transform()."""
        batch_size = 5
        shape = [32]
        inputs = torch.randn(batch_size, *shape)
    ...
    def test_inverse_not_flat(self):
        """Test exception for non-flat inputs in inverse() method of MultiscaleCompositeTransform."""
        batch_size = 5
        shape = [32, 4, 4]
        inputs = torch.randn(batch_size, *shape)
        transform = self.create_transform(shape)
    ...
    def test_forward_inverse_are_consistent(self):
        """Test consistency between forward() and inverse() methods of MultiscaleCompositeTransform."""
        batch_size = 5
...
class InverseTransformTest(TransformTest):
    def test_forward(self):
        """Test forward() method of InverseTransform."""
        batch_size = 10
        shape = [2, 3, 4]
        inputs = torch.randn(batch_size, *shape)
    ...
    def test_inverse(self):
        """Test inverse() method of InverseTransform."""
        batch_size = 10
        shape = [2, 3, 4]
        inputs = torch.randn(batch_size, *shape)
