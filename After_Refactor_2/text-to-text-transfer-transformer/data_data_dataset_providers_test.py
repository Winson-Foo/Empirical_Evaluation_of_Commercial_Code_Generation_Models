...
import src.immutabledict as immutabledict
import src.seqio as seqio
from src.seqio import test_utils
from src.t5.data import dataset_providers
...
def add_t5_task(name, cls, text_preprocessor=(test_utils.test_text_preprocessor,), output_features=None, **kwargs):
...
class TasksTest(test_utils.FakeTaskTest):
    ...
    def test_text_line_task(self):
        add_t5_task(
            ...
            skip_header_lines=1,
            text_preprocessor=(test_utils.split_tsv_preprocessor, test_utils.test_text_preprocessor)
        )
    ...
    def test_task_registry_reset(self):
        ...
        # Assert that task was added to both t5.data.TaskRegistry and seqio.TaskRegistry.
        ...
        # Assert that task was added to both t5.data.TaskRegistry and seqio.TaskRegistry
        # so that they don't diverge after reset() call.
        self.assertSameElements(TaskRegistry.names(), seqio.TaskRegistry.names())
