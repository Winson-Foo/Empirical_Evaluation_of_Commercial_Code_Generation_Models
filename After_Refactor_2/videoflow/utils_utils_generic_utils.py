...
class Progbar(object):
    ...
    Args:
        ...
        stateful_metrics (set): Iterable of string names of metrics that\
    ...
    def __init__(self, target, width=30, verbose=1, interval=0.05,
        ...
        self.stateful_metrics = set() if stateful_metrics is None else set(stateful_metrics)
        self._total_width = 0
        self._seen_so_far = 0
