...
class BaseAgent:
    ...
    def eval_episodes(self):
        ...
        std_err = np.std(episodic_returns) / np.sqrt(len(episodic_returns))
        self.logger.info('steps %d, episodic_return_test %.2f(%.2f)' % (self.total_steps, mean_returns, std_err))
        self.logger.add_scalar('episodic_return_test', mean_returns, self.total_steps)
        return {'episodic_return_test': mean_returns}
