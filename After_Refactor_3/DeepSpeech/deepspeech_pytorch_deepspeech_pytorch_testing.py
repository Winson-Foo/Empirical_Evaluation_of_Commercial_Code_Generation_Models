...
def load_data(cfg, device):
    ...
    return model, decoder, target_decoder, test_loader
...
def evaluate(cfg: EvalConfig):
    ...
    model, decoder, target_decoder, test_loader = load_data(cfg, device)
...
if __name__ == '__main__':
    cfg = hydra.experimental.initialize_config_module(config_module='deepspeech_pytorch.configs.inference_config')
