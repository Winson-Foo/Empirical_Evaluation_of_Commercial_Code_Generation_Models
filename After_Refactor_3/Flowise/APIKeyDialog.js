...
import { enqueueSnackbar, closeSnackbar } from 'store/actions'
import {
    Box,
    Typography,
    Button,
...
const APIKeyDialog = ({ show, dialogProps, onCancel, onConfirm }) => {
    ...
    const component = show && (
        ...
        >
                ...
                {dialogProps.type === 'EDIT' && (
                    <Box sx={{ p: 2 }}>
                        ...
                        <Stack direction='row' sx={{ mb: 1 }}>
                            ...
                            <IconButton title='Copy API Key' color='success' onClick={handleCopyKey}>
                                <IconCopy />
                            </IconButton>
                            <Popover
                                open={openPopOver}
            ...
            <DialogActions>
                <StyledButton variant='contained' onClick={dialogProps.type === 'ADD' ? handleAddKey : handleUpdateKey}>
