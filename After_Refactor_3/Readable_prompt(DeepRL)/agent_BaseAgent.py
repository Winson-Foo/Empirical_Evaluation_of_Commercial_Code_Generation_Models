...
class BaseAgent:
    ...
    def eval_episodes(self):
        ...
        std_error_of_mean = np.std(episodic_returns) / np.sqrt(len(episodic_returns))
        self.logger.info('steps %d, mean episodic return(test) %.2f(%.2f)' % (self.total_steps, mean_return, std_error_of_mean))
