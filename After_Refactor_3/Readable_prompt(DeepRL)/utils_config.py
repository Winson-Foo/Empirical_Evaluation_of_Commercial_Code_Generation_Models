...
class Config:
    ...
    # Defined default values for all the parameters
    def __init__(self):
    ...
    # Getter method to access 'eval_env' variable
    @property
    def eval_env(self):
        return self.__eval_env

    # Setter method to set the 'eval_env' variable along with updating other values based on this
    @eval_env.setter
    ...
    # Method to add parser arguments
    def add_argument(self, *args, **kwargs):
        self.parser.add_argument(*args, **kwargs)
    
    # Method to merge default values and parsed values
