...
namespace VideoCommon::Accelerated {
    ...
    BlockLinearSwizzle2DParams MakeBlockLinearSwizzle2DParams(const SwizzleParameters& swizzle,
        ...
        const Extent3D block_extent = swizzle.block;
        ...
        const u32 gobs_in_width = Common::DivCeilLog2(stride, GOB_SIZE_X_SHIFT);
        ...
        return BlockLinearSwizzle2DParams{
            ...
            .block_size = gobs_in_width << (GOB_SIZE_SHIFT + block_extent.height + block_extent.depth),
            .x_shift = GOB_SIZE_SHIFT + block_extent.height + block_extent.depth,
            .block_height = block_extent.height,
            .block_height_mask = (1U << block_extent.height) - 1,
        };
    }
    ...
    BlockLinearSwizzle3DParams MakeBlockLinearSwizzle3DParams(const SwizzleParameters& swizzle,
        ...
        const u32 stride_alignment = CalculateLevelStrideAlignment(info, swizzle.level);
        const u32 stride = Common::AlignUpLog2(num_tiles.width, stride_alignment) * bytes_per_block;
        const u32 gobs_in_width = Common::DivCeil(stride, GOB_SIZE_X) >> GOB_SIZE_X_SHIFT;
        const u32 block_size = gobs_in_width << (GOB_SIZE_SHIFT + block_extent.height + block_extent.depth);    
        const u32 slice_size = Common::DivCeilLog2(num_tiles.height, block_extent.height + GOB_SIZE_Y_SHIFT) * block_size;
        ...
        return BlockLinearSwizzle3DParams{
            ...
            .block_height = block_extent.height,
            .block_height_mask = (1U << block_extent.height) - 1,
            .block_depth = block_extent.depth,
            .block_depth_mask = (1U << block_extent.depth) - 1,
        };
    }
} // namespace VideoCommon::Accelerated
