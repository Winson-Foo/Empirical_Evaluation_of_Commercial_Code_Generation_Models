...
class VirtualAdversarialAttack(FixedEpsilonAttack):
    ...
    The attack calculates an untargeted adversarial perturbation by performing an approximated second order optimization step on the KL divergence between
    the unperturbed predictions and the predictions for the adversarial perturbation.
    This attack was originally introduced as the Virtual Adversarial Training method.
