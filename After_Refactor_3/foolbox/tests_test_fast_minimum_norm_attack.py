...
def preprocess_input(fmodel, x, y):
...
def run_untargeted_attack(fmodel_and_data_ext_for_attacks, attack_and_p):
    (fmodel, x, y), real, low_dimensional_input = fmodel_and_data_ext_for_attacks
    fmodel, x, y = preprocess_input(fmodel, x, y)
...
def run_targeted_attack(fmodel_and_data_ext_for_attacks, attack_and_p):
    (fmodel, x, y), real, low_dimensional_input = fmodel_and_data_ext_for_attacks
    fmodel, x, y = preprocess_input(fmodel, x, y)
...
def test_fast_minimum_norm_untargeted_attack(
    ...
    run_untargeted_attack(fmodel_and_data_ext_for_attacks, attack_and_p)
...
def test_fast_minimum_norm_targeted_attack(
    ...
    run_targeted_attack(fmodel_and_data_ext_for_attacks, attack_and_p)