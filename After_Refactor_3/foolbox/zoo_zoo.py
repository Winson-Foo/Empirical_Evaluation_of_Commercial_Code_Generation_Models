...
def get_model(url: str, module_name: str = "foolbox_model", overwrite: bool = False, **kwargs: Any) -> Model:
    ...
    of parameters to this method's call. These parameters are forwarded to
    ...
    Args:
        ...
        overwrite (bool): Whether to overwrite the existing repository if it exists.
        **kwargs (Any): Optional set of parameters that will be used by the instantiated model.

    Returns:
        Model: A Foolbox-wrapped model instance.
    """
