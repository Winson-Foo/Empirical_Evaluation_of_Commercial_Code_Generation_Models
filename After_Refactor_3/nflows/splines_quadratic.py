...
def unconstrained_quadratic_spline(
    ...
    """
    Unconstrained quadratic spline transformation.

    Args:
        inputs: The input tensor.
        unnormalized_widths: The unnormalized widths tensor.
        unnormalized_heights: The unnormalized heights tensor.
        inverse: Boolean indicating whether to perform the inverse transformation.
        tail_bound: The bound of the interval where the transformation is applied.
        tails: The type of tails used in the transformation.
        min_bin_width: The minimal bin width.
        min_bin_height: The minimal bin height.

    Returns:
        The transformed tensor and the log absolute determinant of the transformation.
    """
...
def quadratic_spline(
    ...
    """
    Quadratic spline transformation.
    ...
    Args:
        ...
        bottom: The bottom boundary of the interval.
        top: The top boundary of the interval.
        min_bin_width: The minimal bin width.
        min_bin_height: The minimal bin height.
