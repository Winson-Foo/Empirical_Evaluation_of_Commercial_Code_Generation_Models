...
class LULinear(Linear):
    ...
    def _initialize(self, identity_init):
        """Initializes the parameters of the linear transform"""
    ...
    def _create_lower_upper(self):
        """Creates lower and upper triangular matrices from the parameters"""
    ...
    def forward_no_cache(self, inputs):
        ...
        Returns:
            outputs: Transformed inputs
            logabsdet: Log absolute determinant
        """
    ...
    def inverse_no_cache(self, inputs):
        """
        Inverse pass without cache.

        Args:
            inputs: Input tensor

        Returns:
            outputs: Inverse transformed inputs
            logabsdet: Log absolute determinant
        """
        lower, upper = self._create_lower_upper()
    ...
    def upper_diag(self):
        """
        Computes the upper diagonal matrix.
    ...
    def logabsdet(self):
        """
        Computes the logarithm of the absolute determinant.

        Returns:
            Logarithm of the absolute determinant
        """
