...
class ExpTest(TransformTest):
    """Tests for the Exp nonlinearity."""
...
class TanhTest(TransformTest):
    """Tests for the Tanh nonlinearity."""
...
class TestPiecewiseCDF(TransformTest):
    """Tests for the Piecewise CDF nonlinearity transforms."""

    def setUp(self):
        """Set up the test by initializing the required variables."""
        self.shape = [2, 3, 4]
        self.batch_size = 10
        self.transforms = [
    ...
    def test_raises_domain_exception(self):
        """Test if the transform raises a domain exception for invalid inputs."""
    ...
    def test_zeros_to_zeros(self):
        """Test if the transform maps zeros to zeros."""
        for transform in self.transforms:
    ...
    def test_ones_to_ones(self):
        """Test if the transform maps ones to ones."""
        for transform in self.transforms:
    ...
    def test_forward_inverse_are_consistent(self):
        """Test if the forward and inverse transformations are consistent."""
        for transform in self.transforms:
...
class TestUnconstrainedPiecewiseCDF(TransformTest):
    """Tests for the unconstrained Piecewise CDF nonlinearity transforms."""
...
class LogitTest(TransformTest):
    """Tests for the Logit nonlinearity."""
...
class NonlinearitiesTest(TransformTest):
    """Tests for various nonlinearity transforms."""
