...
class DQNActor(BaseActor):
    ...
    def _transition(self):
        ...
        entry = Transition(self._state, action, reward, next_state, done, info)
        self._total_steps += 1
    ...
    def step(self):
        ...
        for transition in transitions:
            ...
            self.replay.feed(dict(
                ...
                reward=config.reward_normalizer(transition.reward),
                mask=1 - np.asarray(transition.done, dtype=np.int32),
            ))
