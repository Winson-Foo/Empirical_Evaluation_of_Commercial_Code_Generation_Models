...
print(target_path)
target_path = str(target_path) + "\After_Refactor_3\image_super_resolution"

sys.path.append(target_path)
print(target_path)
import utils_datahandler
...
class DataHandlerTest(unittest.TestCase):
    ...
    def test__make_img_list_non_validation(self):
        with patch('os.listdir', side_effect=self.fake_folders):
            with patch('utils_datahandler.DataHandler._check_dataset', return_value=True):
                DH = utils_datahandler.DataHandler(
    ...
    def test__not_flat_with_flat_patch(self):
        ...
        with patch('utils_datahandler.DataHandler._make_img_list', return_value=True):
            with patch('utils_datahandler.DataHandler._check_dataset', return_value=True):
                DH = utils_datahandler.DataHandler(
