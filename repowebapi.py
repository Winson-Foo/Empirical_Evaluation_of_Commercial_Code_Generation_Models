...
HEADER_ARR = ["fileName","Issues","BUG","CODE_SMELL","VULNERABILITY","INFO","MINOR","MAJOR","CRITICAL","BLOCKER"]
...
param = {'componentKeys' : 'Winson-Foo_Empirical_Evaluation_of_Commercial_Code_Generation_Models:' + FOLDER_NAME[0] + '/' +FILE_NAME[0], 'resolved':'false','branch':'test','ps':'500'}
